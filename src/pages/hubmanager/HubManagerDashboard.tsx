...
import { workspaces, checkIns } from "@/data/workspaces";
...
const HubManagerDashboard = () => {
  ...
  // Filter the check-ins to only show today's
  const todayCheckIns = checkIns.map(checkIn => ({
    ...checkIn,
    checkInTime: new Date(checkIn.checkInTime),
    checkOutTime: checkIn.checkOutTime ? new Date(checkIn.checkOutTime) : undefined
  }));
  ...
  return (
    <HubManagerLayout>
      <div className="w-full max-w-7xl mx-auto pb-10">
        <div className="mb-6">
          <h1 className="text-2xl md:text-3xl font-bold text-deskhive-navy mb-2">Hub Manager Dashboard</h1>
