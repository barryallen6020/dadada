...
const PreLaunch = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col relative overflow-hidden bg-deskhive-navy">
              ...
              <div className="flex items-center space-x-2 mb-8">
                <div className="flex -space-x-3">
                  {[...Array(4)].map((_, i) => (
                    <div 
                      key={i} 
                      className="w-8 h-8 rounded-full bg-gradient-to-br from-deskhive-orange/80 to-deskhive-navy border-2 border-white/20"
                    ></div>
                  ))}
                </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 mt-4 md:mt-0">
              <a href="/terms-of-service" className="text-white/60 text-sm hover:text-white">Terms</a>
              <a href="/privacy-policy" className="text-white/60 text-sm hover:text-white">Privacy</a>
              <a href="/contact" className="text-white/60 text-sm hover:text-white">Contact</a>
            </div>
          </div>
        </div>
      </footer>
